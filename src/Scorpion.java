...
/** Class extends abstract Entity class. Makes up functionality of Scorpion enemy objects
 */
public class Scorpion extends Entity{
     ...
     */
    public Scorpion(GameController gameController) throws IOException {
    ...
    public void getEntityImage() throws IOException {
        this.rightImg = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/scorpionRight.png")));
        this.leftImg = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/scorpionLeft.png")));
    }
